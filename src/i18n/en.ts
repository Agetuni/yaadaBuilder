...
export const en: typeof zh = {
  ...
  toolbar: {
    ...
    updateTitle: "Update published project",
    publishDescription:
      "Enter a client UUID that exists in the clients table. A public preview link will be created.",
    clientUuid: "Client UUID",
    clientUuidPlaceholder: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
    clientUuidRequired: "Client UUID is required",
    clientUuidInvalid: "Invalid client UUID format",
    shareUrl: "Share URL",
    copyLink: "Copy link",
    copyFailed: "Failed to copy link",
    unpublish: "Unpublish",
    close: "Close",
    publishSignIn: "Sign in to publish",
    publishNeedProject: "Generate a project before publishing",
    publishFailed: "Publish failed",
  },
  published: {
    loading: "Loading…",
    notFound: "Published site not found",
    builtWith: "Built by Yaada Labs · +251940556969",
  },
  console: {
    hide: "Hide Console",
    show: "Show Console",
