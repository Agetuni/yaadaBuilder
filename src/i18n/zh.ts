export const zh = {
  ...
  toolbar: {
    ...
    updateTitle: "更新已发布项目",
    publishDescription:
      "输入客户 UUID（必须存在于 clients 表）。发布后将生成可公开访问的预览链接。",
    clientUuid: "客户 UUID",
    clientUuidPlaceholder: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
    clientUuidRequired: "请填写客户 UUID",
    clientUuidInvalid: "客户 UUID 格式无效",
    shareUrl: "分享链接",
    copyLink: "复制链接",
    copyFailed: "复制失败",
    unpublish: "取消发布",
    close: "关闭",
    publishSignIn: "请先登录后再发布",
    publishNeedProject: "请先生成项目后再发布",
    publishFailed: "发布失败",
  },
  published: {
    loading: "加载中…",
